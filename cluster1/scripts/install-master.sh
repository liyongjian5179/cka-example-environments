...
kubeadm reset -f
kubeadm init --kubernetes-version=1.18.2 --apiserver-advertise-address=$MASTER_IP --pod-network-cidr=$POD_NW_CIDR --image-repository=registry.aliyuncs.com/google_containers
